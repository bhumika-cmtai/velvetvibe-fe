            ...
            <div className="py-4 max-h-[70vh] overflow-y-auto pr-4">
              ...
              <TabsContent value="jewellery">
                <div className="grid grid-cols-2 gap-4 border-t pt-4">
                    ...
                    <div className="col-span-1"><Label>Category</Label><Select onValueChange={(v) => handleSelectChange('jewelleryCategory', v)}><SelectTrigger><SelectValue placeholder="Select" /></SelectTrigger><SelectContent><SelectItem value="Rings">Rings</SelectItem><SelectItem value="Earrings">Earrings</SelectItem><SelectItem value="Necklaces">Necklaces</SelectItem></SelectContent></Select></div>
